...
Cloud.prototype.init = function() {
	loadMesh(assetPath + "cloud.js", this.loadCloud);
};

Cloud.prototype.playAnimation = function( delta ) {
	var mesh = this.mesh;
...
Cloud.prototype.loadCloud = function(geometry) { 
printf('load cloud start');
	...
	cloud.mesh.position.set(cloudPosition.x, cloudPosition.y, cloudPosition.z);
