...
function Flower( index ) {
	...
	this.rotateSpeed = 0.0075 * this.direction;
}

Flower.prototype.init = function() {
	loadMesh(assetPath + "flower.js", this.loadFlower);
};
...
Flower.prototype.loadFlower = function( geometry ) { printf('load flower start');
	...
	flowerCurIndex++; printf('load flower finished');
}