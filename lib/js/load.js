...
function loadLeft(geometry) {
	...
	left = createScene(geometry, x, y, 0, 0, 0, 0, 1, true, assetPath + "floor2.png", isPortrait);
}
...
function loadRight(geometry) {
	...
	right = createScene(geometry, x, y, 0, 0, 0, 0, 1, true, assetPath + "floor3.png", isPortrait);
}
...
function loadBackground(geometry) {
	...
	bg = createScene(geometry, 0, 0, -10, Math.PI / 2, ry, Math.PI, 300, false, assetPath + "iPhone_Back_Gloss.jpg", false);
}
