...
function loadKakaoBox(geometry) {
	kakaoBox = createScene(geometry, -200, 70, 5, 0, 0, 0, 25, true, assetPath + "yellow.jpg", isPortrait);
...
function loadMapBox(geometry) {
	mapBox = createScene(geometry, 100, 70, 5, 0, 0, 0, 25, true, assetPath + "green.jpg", isPortrait);
