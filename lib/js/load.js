...
function loadLeft(geometry) {
	...
	left = createScene(geometry, x, y, z, 0, 0, 0, 1, true, assetPath + "floor2.png", isPortrait);
}
...
function loadRight(geometry) {
	...
	right = createScene(geometry, x, y, z, 0, 0, 0, 1, true, assetPath + "floor3.png", isPortrait);
}
